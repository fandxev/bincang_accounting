<?php
require_once './models/Bincang_Reason_Deduction.php';


class ReasonDeductionController
{
    private $model;

    public function __construct($db)
    {
        $this->model = new Bincang_Reason_Deduction($db);
    }
    ...
    public function patch($id)
{
    ...
    $new_reason_deduction_uuid = isset($data['reason_deduction_uuid']) ? $data['reason_deduction_uuid'] : null;

    $updateData = [
        'reason'     => $new_reason,
        'user_uuid'       => $new_user_uuid,
        'reason_deduction_uuid'  => $new_reason_deduction_uuid,
    ];
