<?php
require_once './models/Bincang_Reason_Bonus.php';


class ReasonBonusController
{
    private $model;

    public function __construct($db)
    {
        $this->model = new Bincang_Reason_Bonus($db);
    }
    ...
    public function patch($id)
{
    ...
    $new_reason_bonus_uuid = isset($data['reason_bonus_uuid']) ? $data['reason_bonus_uuid'] : null;

    $updateData = [
        'reason'     => $new_reason,
        'user_uuid'       => $new_user_uuid,
        'reason_bonus_uuid'  => $new_reason_bonus_uuid,
    ];
